...
1. Item Instalación de Paquetes:

Ejecute el script instalar_paquetes.sh para instalar todos los paquetes necesarios para el proyecto.

./instalar_paquetes.sh

2. Item Configuración de Correos:

Ejecute configuracion_correos.sh para configurar el correo emisor y la contraseña de aplicación. Si usa Gmail, puede generar una contraseña de aplicación en [https://myaccount.google.com/apppasswords](URL).
...
4. Item Prueba de Sobrecarga (Opcional):
